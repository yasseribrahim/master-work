...
import com.search.engine.indexing.DrMohammedIndexing;
 ...
 * @author interactive
 */
public class DrMohammedTFIDFManager {

    private final DatasetManager dataset;
    private final DrMohammedIndexing indexing;
    private final IndexingUtil util;
    private final Exporter exporter;
    private IndexReader reader;
    private Tree<Bag> tree;

    public static DrMohammedTFIDFManager getManager(String workingDirectory, String datasetDirectory) {
        return new DrMohammedTFIDFManager(workingDirectory, datasetDirectory);
    }

    private DrMohammedTFIDFManager(String workingDirectory, String datasetDirectory) {
        this.dataset = DatasetManager.getManager(datasetDirectory, workingDirectory);
        indexing = DrMohammedIndexing.getIndexing(workingDirectory, datasetDirectory);
    ...
    public final boolean buildModel() {
        try {
            indexing.buildIndex();
            ((DrMohammedIndexing) indexing).buildPublicIndex();
            calculateAndExport();
//            exporter.exporter(tree, dataset.getTreeFile().getAbsolutePath());
    ...
    public static void main(String... args) throws Exception {
        String workingDir = "/home/interactive/Desktop/Computer/Projects/DrMohamed/Working Dir" + FileManager.FILE_SEPARATOR;
        String datasetDir = "/home/interactive/Desktop/Computer/Projects/DrMohamed/dataset";
...
//        validateTree(workingDir, datasetDir);
    ...
    public static void validateTree(String workingDir, String datasetDir) throws Exception {
        DrMohammedTFIDFManager manager = getManager(workingDir, datasetDir);
    ...
    public static void getResults(String workingDir, String datasetDir) throws Exception {
        ...
        for (DatasetManager.Data data : manager.dataset.getDatas()) {
            searcher = new IndexSearcher(manager.util.getIndexReader(data.getName()));
