...
import com.search.engine.indexing.HtmlIndexing;
...
public class TFIDFManager {
    ...
    private final HtmlIndexing indexing;
    private final IndexingUtil util;
    private final Exporter exporter;
    private IndexReader reader;
    private Tree<Bag> tree;

    public static TFIDFManager getManager(String workingDirectory, String datasetDirectory) {
        return new TFIDFManager(workingDirectory, datasetDirectory);
    }

    private TFIDFManager(String workingDirectory, String datasetDirectory) {
        this.dataset = DatasetManager.getManager(datasetDirectory, workingDirectory);
        indexing = HtmlIndexing.getIndexing(workingDirectory, datasetDirectory);
...
//            exporter.exporter(tree, dataset.getTreeFile().getAbsolutePath());
    ...
    public static void main(String... args) throws Exception {
        ...
        String datasetDir = "/home/interactive/Desktop/Master Work/dataset";
...
//        getResults2(workingDir, datasetDir);
    ...
    public static void validateTree(String workingDir, String datasetDir) throws Exception {
        TFIDFManager manager = getManager(workingDir, datasetDir);
